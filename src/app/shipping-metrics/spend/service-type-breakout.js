...
const Service_Type_Breakout = () => {
  ...
  const getData = () => {
    fetch(`http://ec2-44-202-145-148.compute-1.amazonaws.com/api-queries/shipping_metrics/spend/service_type_breakout/8258/?type_search=${filter[filterType]}${account ? `&account_number_search=${account}` : ''}&${valueRadio === 1 ? 'quarter' : 'month'}_search=${customDate}`, {
      method: "GET"
    })
